...
class _CategoryBookingScreenState extends State<CategoryBookingScreen> {
  ...
  final int _maxTotalTicketsAllowed = 4; // Max 4 tickets across all categories for this demo
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Text('BOOK YOUR TICKET', style: Theme.of(context).textTheme.titleLarge),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text('Ticket', style: Theme.of(context).textTheme.bodyLarge),
                        Text('RP${(widget.price * _numberOfTickets / 1000).toStringAsFixed(0)}K', style: Theme.of(context).textTheme.bodyLarge),
                      ],
                    ),
                  ),
                ],
      ...
      child: Column(
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text('Number of Tickets', style: Theme.of(context).textTheme.bodyLarge),
              Row(
                children: [
                  IconButton(
                    icon: Icon(
                      Icons.remove_circle,
                      color: _numberOfTickets > 0 ? const Color(0xFF00D4FF) : Colors.grey,
                    ),
                    onPressed: () {
                      setState(() {
                  ...
                  IconButton(
                    icon: Icon(
                      Icons.add_circle,
                      color: _numberOfTickets < _maxTicketsPerCategory ? const Color(0xFF00D4FF) : Colors.grey,
                    ),
                    onPressed: () {
                      setState(() {
                        if (_numberOfTickets < _maxTicketsPerCategory) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: Text('Cannot buy more than $_maxTicketsPerCategory tickets for this category!')),
                          );
                        }
                      });
                    },
