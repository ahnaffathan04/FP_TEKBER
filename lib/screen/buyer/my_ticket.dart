      ...
      appBar: PreferredSize(
        ...
        child: Container(
          decoration: const BoxDecoration(
            gradient:
                LinearGradient(colors: [Color(0xFF101316), Color(0xFF161821)]),
            border:
                Border(bottom: BorderSide(color: Color(0xFF1D1E2D), width: 1)),
          ),
            ...
            GestureDetector(
              onTap: () {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        const ConcertDetailScreen(showFeedbackForm: false),
                  ),
                );
              },
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (_) => const YourTicketListScreen()),
                );
              },
              child: Container(
                padding:
      ...
      child: Stack(
        children: [
          Positioned.fill(
              child: ClipRRect(
                  borderRadius: BorderRadius.circular(12),
                  child: const Opacity(opacity: 0.25))),
          const Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(children: [
                  ...
                  SizedBox(width: 8),
                  Text('Jatim International Expo (JIE)',
                      style: TextStyle(color: Colors.white))
                ]),
                SizedBox(height: 8),
          ...
          onTap: () {
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                ...
                builder: (context) =>
                    const ConcertDetailScreen(showFeedbackForm: true),
              ),
            );
          },
