...
class _EditKonserScreenState extends State<EditKonserScreen> {
  ...
  void initState() {
    ...
    _namaKonserController =
        TextEditingController(text: widget.concert_table['concert_name']);
    _tanggalController = TextEditingController(text: widget.concert_table['concert_name']);
    ...
    _deskripsiController =
        TextEditingController(text: widget.concert_table['description']);
  }
