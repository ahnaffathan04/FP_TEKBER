...
class OrganizerAccountScreen extends StatefulWidget {
  const OrganizerAccountScreen({super.key});

  @override
  _OrganizerAccountScreenState createState() => _OrganizerAccountScreenState();
}

class _OrganizerAccountScreenState extends State<OrganizerAccountScreen> {
  bool _loading = true;
