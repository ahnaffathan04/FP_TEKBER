          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: widget.concert_table['concert_poster'] != null &&
                        widget.concert_table['concert_poster'] != ''
                    ? DecorationImage(
                        image: NetworkImage(widget.concert_table['concert_poster']),
                        fit: BoxFit.cover,
            ...
            Text(
              widget.concert_table['concert_name'] ?? '',
            ...
            Text(
              formatTanggal(widget.concert_table['concert_date'] ?? ''),
              style: const TextStyle(
                color: Colors.white,
                fontFamily: 'Poppins',
                fontWeight: FontWeight.w600,
            ...
            Text(
              widget.concert_table['description'] ?? '',
              style: const TextStyle(
                color: Colors.white,
                fontFamily: 'Poppins',
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                TambahTiketScreen(concert_table: widget.concert_table),
                          ),
                        );
                      },
                      child: const Text(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              EditKonserScreen(concert_table: widget.concert_table),
                        ),
                      );
                    },
                    child: const Text(
